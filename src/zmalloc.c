...
#define mallocx(size,flags) mi_mallocx(size,flags)
#define rallocx(ptr,size,flags) mi_rallocx(ptr,size,flags)
#define dallocx(ptr,flags) mi_dallocx(ptr,flags)
#define malloc_with_usize(size,usize) mi_umalloc(size,usize)
#define calloc_with_usize(num,size,usize) mi_ucalloc(num,size,usize)
#define realloc_with_usize(ptr,size,old_usize,new_usize) mi_urealloc(ptr,size,old_usize,new_usize)
#define free_with_usize(ptr,usize) mi_ufree(ptr,usize)
